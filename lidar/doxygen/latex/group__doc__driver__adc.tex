\hypertarget{group__doc__driver__adc}{}\doxysection{ADC Drivers}
\label{group__doc__driver__adc}\index{ADC Drivers@{ADC Drivers}}
\doxysubsection*{Modules}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{group__doc__driver__adc__window}{ADC Window Driver}}
\begin{DoxyCompactList}\small\item\em Driver for window ADC functionality. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyItemize}
\item doc\+\_\+driver\+\_\+adc\+\_\+init \+: Init driver initializing the ADC hardware as specified by the user in START.
\item doc\+\_\+driver\+\_\+adc\+\_\+basic \+: Provides basic functionality like\+:
\begin{DoxyItemize}
\item Initializing the ADC as specified by the user in START
\item Starting a conversion on a specified channel
\item Polling whether a conversion is done
\item Getting the conversion result
\item Polled or interrupt-\/driven interfaces, selectable from START
\end{DoxyItemize}
\item \mbox{\hyperlink{group__doc__driver__adc__window}{ADC Window Driver}} \+: Provides advanced functionality like\+:
\begin{DoxyItemize}
\item Initializing the ADC as specified by the user in START
\item Starting auto-\/triggered conversions on a specified channel
\item Let conversions be triggered by the event system
\item Getting interrupts if the conversion is inside/outside a specified window range
\item Getting the conversion result
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{group__doc__driver__adc_doc_driver_adc_basic_and_practice}{}\doxysubsection{ADC Basics and Best Practice}\label{group__doc__driver__adc_doc_driver_adc_basic_and_practice}
